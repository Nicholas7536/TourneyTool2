...
`ENABLE_TEST_HARNESS=true`, start the app, and open `http://localhost:5173/?harness=1` instead of just `http://localhost:5173/`. when running 'corepack pnpm run dev' /?harness=1

Create a fresh 15-player room, then open the isolated player sessions to exercise the normal
